...
import com.mypet.web.tx.TxMapper;
...
public class ArticleProxy {
	...
	public ArrayList<String> content() {
		...
		return jeno.choose(trunk.get()).getList();
	}
	...
	public void insertArticle() {
		...
		for (int i = 1; i <= 5; i++) {
			...
			txMapper.insertArticles(new Article(articleseq(), img(), writerUid(), comments(), msg(), title(), t.get(0), category(), rating()));
		}
	}
}